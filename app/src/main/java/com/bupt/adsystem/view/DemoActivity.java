...
//                startLive();
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent i = new Intent(DemoActivity.this,RTMPActivity.class);
//                startActivity(i);
                RTMPActivity.intentTo(DemoActivity.this,"rtmp://aokai.lymatrix.com/aokai/test25.mp4","customTest");
            }
        });
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DemoActivity.this,MainAdActivity.class);
                startActivity(i);
            }
        });
    }
    ...
    private void startLive(){
        Intent it = new Intent(this, FileExplorerActivity.class);
