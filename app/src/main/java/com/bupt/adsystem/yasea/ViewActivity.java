...
public class ViewActivity extends AppCompatActivity implements RtmpHandler.RtmpListener,
...
//    private String recPath = Environment.getExternalStorageDirectory().getPath() + "/test.mp4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yasea_rtmp);
